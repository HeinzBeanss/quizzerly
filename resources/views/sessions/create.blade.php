    ...
    <section class="relative flex flex-col items-center justify-center min-h-screen">
        <div
            ...
            <div class="border-t border-background/20 mt-2 sm:mx-auto sm:w-full sm:max-w-sm ">
                <form class="space-y-2 sm:space-y-6" action="/login" method="POST">
                    @csrf
                    <div>
                    ...
                    <div>
                        <button type="submit"
                            class="flex w-full justify-center rounded-md bg-gradient-to-tl from-background to-surface px-3 py-1.5 text-sm leading-6 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-background mt-4 sm:mt-0">Log
                            in</button>
                    </div>
                </form>
