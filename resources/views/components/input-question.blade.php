    ...
    <div id="questionContainerBottom0" class="flex flex-col gap-4">
        <div class="answercontainerdefault flex justify-between gap-3">
            ...
            <input type="text" name="question[0][1]" placeholder="October 14, 1066" required
                class="max-h-24 pl-2 block w-full rounded-md border-0 py-1.5 text-background/80 shadow-sm ring-1 ring-inset ring-faint focus:ring-1 focus:outline-0 focus:ring-surface sm:text-sm sm:leading-6 placeholder-background/50">
        </div>
